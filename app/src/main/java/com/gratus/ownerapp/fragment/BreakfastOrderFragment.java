...
public class BreakfastOrderFragment extends Fragment implements AcceptMoreClickItemListerner, OrderMoreClickItemListerner, RejectMoreClickItemListerner {
    ...
    private void setAdapter() {
        ...
        breakfastRecyclerView.setAdapter(mAdapter);
        mAdapter.notifyDataSetChanged();
        mAdapter.setAcceptMoreClickItemListerner(BreakfastOrderFragment.this);
        mAdapter.setOrderMoreClickItemListerner(BreakfastOrderFragment.this);
        mAdapter.setRejectMoreClickItemListerner(BreakfastOrderFragment.this);
    }

    public static BreakfastOrderFragment  newInstance() {
        BreakfastOrderFragment frag = new BreakfastOrderFragment();
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putSerializable("breakfast", noofOrderAdapterModel);
    }
    ...
    public void onMoreClick(int position) {
        ...
        startActivityForResult(intent, ACCEPT_REJECT_CODE);
